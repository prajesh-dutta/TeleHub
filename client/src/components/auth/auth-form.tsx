  ...
  return (
    <div className="space-y-6">
        ...
        <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
          <div>
            ...
            <Input
              ...
              className="bg-slate-800/50 border-purple-800/30 text-white placeholder-gray-400 focus:border-yellow-500"
          ...
          <Button 
            type="submit" 
            className="w-full purple-gradient text-white hover:opacity-90 transition-all"
      ...
      <Button 
        type="button" 
        variant="outline"
        className="w-full bg-white text-slate-900 border-white hover:bg-gray-100 transition-colors flex items-center justify-center"
      >
