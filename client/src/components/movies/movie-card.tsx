...
export default function MovieCard({ movie, compact = false }: MovieCardProps) {
  ...
  if (compact) {
    return (      <div className="group cursor-pointer relative" onClick={handleMovieClick}>
        <div className="relative overflow-hidden rounded-xl mb-3 transform transition-all duration-500 hover:scale-105 hover:z-20">
          ...
          <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-xl overflow-hidden">
            {imageUrl ? (
              ...
              {/* Overlay with Netflix-style gradient */}
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black via-black/80 to-transparent">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Button className="w-full bg-white/95 hover:bg-white text-black font-semibold rounded-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm" onClick={handleWatchNow}>
    ...
    <div className="group cursor-pointer relative" onClick={handleMovieClick}>
      {/* Glow effect */}
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-black via-black/90 to-transparent">
            ...
            <h3 className="text-3xl font-bold mb-3 text-transparent bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text">
              ...
              {movie.overview || "A cinematic experience waiting to be discovered. Immerse yourself in storytelling at its finest."}
            </p>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">                <Button 
                ...
                <Button onClick={handleWatchNow} className="bg-gradient-to-r from-white to-gray-100 hover:from-gray-100 hover:to-white text-black font-bold px-6 py-3 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg">
